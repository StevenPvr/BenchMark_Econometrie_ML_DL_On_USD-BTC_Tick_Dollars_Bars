...
def _load_trained_model_hyperparameters() -> tuple[int, int, str, int, str, int | None]:
    ...
    from src.path import GARCH_MODEL_METADATA_FILE
...
def _save_combined_forecasts(
    ...
    """
    from src.model.econometrie.garch.training_garch.predictions_io import save_garch_forecasts
...
def _prepare_forecast_data(
    ...
    from src.model.econometrie.garch.training_garch.utils import _extract_direct_residuals
