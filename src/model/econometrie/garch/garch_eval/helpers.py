...
from src.path import GARCH_FORECASTS_FILE, GARCH_MODEL_FILE
...
def _build_forecast_row(
    ...
    """
    # Import locally to avoid circular dependency
    from src.garch.garch_eval.eval import prediction_interval, value_at_risk # type: ignore[import-untyped]
